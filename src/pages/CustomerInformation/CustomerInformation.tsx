    ...
    <div className='main-container'>
      ...
      <div className='rectangle-b'>
        ...
        <span className='reminder-text'>
          Nếu quý khách nhập địa chỉ thư điện tử và không hoàn thành việc đặt
          phòng thì chúng tôi có thể nhắc nhở để giúp quý khách tiếp tục đặt
          phòng.
        </span>  
        ...
        <div className='rectangle-14'>
          ...
          <span className='chon-loai-giuong'>
      ...
      <div className='rectangle-1a'>
        <div className='accept-terms'>
          <span className='accept-terms-1b'>
            Thực hiện bước tiếp theo đồng nghĩa với việc bạn chấp nhận
          </span>
